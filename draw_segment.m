%
% function new_img = draw_segment(img, p1, p2, width, r, g, b)
%
% The function draw_segment creates an image based on the argument "img"
% and returns a new image with a line segment drawn into it. We assume that
% "img" is a three channel, RGB, image. The line goes from p1 to p2, where p1
% and p2 are coordinates in Matlab "ij" image space. The width of the line is
% 1+2*width pixels. The color is specified by the last three arguments r,g,b,
% which are assumed to be a reasonable type and range for "img". 
%
% This function used to be called "draw_line". That name has been given to a
% routine that draws lines specified as such. 
